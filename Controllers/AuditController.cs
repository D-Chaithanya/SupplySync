...
namespace SupplySync.Controllers
{
    ...
    public class AuditController : ControllerBase
    {
        ...
        /// <summary>
        /// Creates a new audit record using the specified request data.
        /// </summary>
        /// <param name="dto">The data transfer object containing the information required to create the audit. Cannot be null.</param>
        /// <returns>An IActionResult containing a success message and the identifier of the created audit record.</returns>
        [HttpPost]        
