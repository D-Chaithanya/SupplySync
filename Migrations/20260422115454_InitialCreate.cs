    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorApplication", x => x.ApplicationID);
                });

            migrationBuilder.CreateTable(
                name: "VendorCategoryConfig",
                columns: table => new
                {
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorCategoryConfig", x => x.VendorCategoryID);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_VendorApplicationDocument", x => x.DocumentID);
                    table.ForeignKey(
                        name: "FK_VendorApplicationDocument_VendorApplication_ApplicationID",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DeliveryTimelineDays = table.Column<int>(type: "int", nullable: true),
                    QualityRequirement = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_VendorApplicationDocument_ApplicationID",
